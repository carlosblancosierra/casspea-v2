...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'CassPea Chocolates <info@casspea.co.uk>'
...
SHIPPING_DISCOUNT_THRESHOLD = 50  # £ cart total required for the discount
SHIPPING_DISCOUNT_AMOUNT = '4.99'  # £ taken off each shipping option
